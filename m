Return-Path: <linux-acpi+bounces-2223-lists+linux-acpi=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-acpi@lfdr.de
Delivered-To: lists+linux-acpi@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 01D40809C6A
	for <lists+linux-acpi@lfdr.de>; Fri,  8 Dec 2023 07:33:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id B079428200A
	for <lists+linux-acpi@lfdr.de>; Fri,  8 Dec 2023 06:33:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6EF6C107A7
	for <lists+linux-acpi@lfdr.de>; Fri,  8 Dec 2023 06:33:29 +0000 (UTC)
X-Original-To: linux-acpi@vger.kernel.org
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
	by lindbergh.monkeyblade.net (Postfix) with ESMTP id 48F2D1984;
	Thu,  7 Dec 2023 21:40:22 -0800 (PST)
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
	by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 8DACE1063;
	Thu,  7 Dec 2023 21:41:07 -0800 (PST)
Received: from a077893.blr.arm.com (a077893.blr.arm.com [10.162.41.8])
	by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPA id 4EAA63F5A1;
...
Subject: [PATCH V3 06/10] coresight: catu: Move ACPI support from AMBA driver to platform driver
Date: Fri,  8 Dec 2023 11:09:35 +0530
Message-Id: <20231208053939.42901-7-anshuman.khandual@arm.com>
...
- Dropped pm_runtime_put() from __catu_probe()
- Added pm_runtime_put() on success path in catu_probe()
- Added pm_runtime_put() on success/error paths in catu_platform_probe()
- Moved out coresight_init_driver()/coresight_remove_driver() helpers
...
index 3949ded0d4fa..daea7c6ba959 100644
...
+
 static struct amba_id catu_ids[] = {
 	...
 	{},
@@ -598,13 +612,101 @@ static struct amba_driver catu_driver = {
 	.id_table			= catu_ids,
 };
