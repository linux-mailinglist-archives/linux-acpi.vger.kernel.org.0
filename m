Return-Path: <linux-acpi+bounces-1801-lists+linux-acpi=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-acpi@lfdr.de
Delivered-To: lists+linux-acpi@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DAEA7F666C
	for <lists+linux-acpi@lfdr.de>; Thu, 23 Nov 2023 19:39:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 717CB1C20C02
	for <lists+linux-acpi@lfdr.de>; Thu, 23 Nov 2023 18:39:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D69143FB0B
	for <lists+linux-acpi@lfdr.de>; Thu, 23 Nov 2023 18:39:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dkim=none
X-Original-To: linux-acpi@vger.kernel.org
Received: from frasgout.his.huawei.com (frasgout.his.huawei.com [185.176.79.56])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 96C8B10DD;
	Thu, 23 Nov 2023 09:44:12 -0800 (PST)
Received: from lhrpeml500006.china.huawei.com (unknown [172.18.147.206])
	by frasgout.his.huawei.com (SkyGuard) with ESMTP id 4SblnJ4VNMz6K8sP;
	Fri, 24 Nov 2023 01:42:44 +0800 (CST)
Received: from SecurePC30232.china.huawei.com (10.122.247.234) by
 lhrpeml500006.china.huawei.com (7.191.161.198) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.35; Thu, 23 Nov 2023 17:44:09 +0000
...
Subject: [PATCH v3 07/11] cxl/memscrub: Register CXL device patrol scrub with scrub configure driver
Date: Fri, 24 Nov 2023 01:43:50 +0800
Message-ID: <20231123174355.1176-8-shiju.jose@huawei.com>
...
---
 ...
 drivers/cxl/core/memscrub.c | 197 +++++++++++++++++++++++++++++++++++-
...
index 7c58d56762b3..c09f9fa5044a 100644
...
@@ -261,6 +444,14 @@ int cxl_mem_patrol_scrub_init(struct cxl_memdev *cxlmd)
 	}
