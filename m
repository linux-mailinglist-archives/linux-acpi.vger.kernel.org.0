...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 972B71779DA
	for <lists+linux-acpi@lfdr.de>; Tue,  3 Mar 2020 16:03:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727901AbgCCPDY (ORCPT <rfc822;lists+linux-acpi@lfdr.de>);
        Tue, 3 Mar 2020 10:03:24 -0500
Received: from mx3.molgen.mpg.de ([141.14.17.11]:50013 "EHLO mx1.molgen.mpg.de"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1727851AbgCCPDX (ORCPT <rfc822;linux-acpi@vger.kernel.org>);
        Tue, 3 Mar 2020 10:03:23 -0500
Received: from hypnotoad.molgen.mpg.de (hypnotoad.molgen.mpg.de [141.14.18.16])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        (Authenticated sender: pmenzel)
        by mx.molgen.mpg.de (Postfix) with ESMTPSA id 7779520645A16;
        Tue,  3 Mar 2020 16:03:19 +0100 (CET)
From:   Paul Menzel <pmenzel@molgen.mpg.de>
Subject: [PATCH v2] ACPICA: Log successfully loaded DSDT
To:     "Rafael J. Wysocki" <rjw@rjwysocki.net>,
        Len Brown <lenb@kernel.org>
Cc:     linux-acpi@vger.kernel.org
Message-ID: <be0d1660-e5bd-7366-cb19-ff0361c38dd9@molgen.mpg.de>
Date:   Tue, 3 Mar 2020 16:03:18 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.5.0
MIME-Version: 1.0
Content-Type: multipart/signed; protocol="application/pkcs7-signature"; micalg=sha-256; boundary="------------ms020504060101080300020200"
...
Explicitly log, when the DSDT has been loaded. The timestamp will also he=
lp
analyzing and optimizing the boot speed.
    ...
    [    0.203925] ACPI: 9 ACPI AML tables successfully acquired and load=
ed
...
diff --git a/drivers/acpi/acpica/tbxfload.c b/drivers/acpi/acpica/tbxfloa=
d.c
...
SIb3DQEJBTEPFw0yMDAzMDMxNTAzMTlaMC8GCSqGSIb3DQEJBDEiBCCc12/cXrOxUhcJrvqa
u+riIS0H/EBnxbKG/yKnmi5XJDBsBgkqhkiG9w0BCQ8xXzBdMAsGCWCGSAFlAwQBKjALBglg
...

--------------ms020504060101080300020200--
