...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 78EF1525C97
	for <lists+linux-acpi@lfdr.de>; Fri, 13 May 2022 09:54:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1377906AbiEMHwc (ORCPT <rfc822;lists+linux-acpi@lfdr.de>);
        Fri, 13 May 2022 03:52:32 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43858 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1377904AbiEMHwa (ORCPT
        <rfc822;linux-acpi@vger.kernel.org>); Fri, 13 May 2022 03:52:30 -0400
Received: from bhuna.collabora.co.uk (bhuna.collabora.co.uk [46.235.227.227])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 83F84712C3;
        Fri, 13 May 2022 00:52:27 -0700 (PDT)
Received: from [127.0.0.1] (localhost [127.0.0.1])
        (Authenticated sender: usama.anjum)
        with ESMTPSA id 5F1D81F45CEC
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
        s=mail; t=1652428345;
        bh=ulGdejXQWhr7zpK1Hd3G6yuOFi3Wi+ohdV5V4XcdTNI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 13 May 2022 12:52:09 +0500
...
Subject: [PATCH v13] platform/chrome: Add ChromeOS ACPI device driver
Message-ID: <Yn4OKYrtV35Dv+nd@debian-BULLSEYE-live-builder-AMD64>
MIME-Version: 1.0
...
---
Changes in v13:
- Made error handling better in some functions
...
new file mode 100644
index 0000000000000..50d8a4d4352d6
--- /dev/null
